...
const m1r4: Map<IKey, IValue> = m1.set({key: 'key'}, {value: 'value'})
...
const m2r4: Map<number, number> = m2.set(1, 2)
...
const m3r4: WeakMap<IKey, string> = m3.set({key: 'key'}, '')
...
const m4r4: WeakMap<IKey, number> = m4.set({key: 'key'}, 2)
